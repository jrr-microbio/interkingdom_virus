...
mg_virome = read.delim("otu_table_filtered_reordered_DNA_virome_14124.csv", header = T, sep=",", row.names = 1)
...
mg_bacterial_counts = read.delim("1xdepth_75cov_filtered_coverM_counts_DNA_Bacterial_861.txt", header = T, sep="\t", row.names = 1)

mg_eukfloat_counts = read.delim("1xdepth_75cov_filtered_coverM_counts_DNA_EukFloat_3612.txt", header = T, sep="\t", row.names = 1)

mg_virome_counts = read.delim("1xdepth_75cov_filtered_coverM_counts_DNA_Virome_13735.txt", header = T, sep="\t", row.names = 1)
...
sample_metadata = read.csv("TableSX_sample_metadata.csv")
...
upset_otu_table = read.csv(file="23117_otu_table_filtered_reordered_forUpsets.csv", header=T, sep=',', row.names = 1)
...
manifest_metadat = read.table(file="sample_metadata_dna_weight_seqs.csv", sep = ",", header=T)
...
upset_otu_table = read.csv(file="23117_otu_table_filtered_reordered_forUpsets_nozero.csv", header=T, sep=',', row.names = 1)
...
#DNA abundance 
counts_dna_abund = read.delim("1xdepth_75cov_filtered_coverM_counts.txt", header = T, sep="\t") #coverM out
...
#DNA expression
counts_dna_expression = read.delim("featureCounts_bulk_metaT_DNA_output_reverse-stranded_paired_genome.txt", header = T, sep="\t") #featureCounts out
...
#RNA abundance
counts_rna_abundance = read.delim("bulk_metaT_RNA_vOTU/5893_genes_abundance_vOTUs.csv", header = T, sep=",") #geaParse template strand
...
dnahosts = read.delim("parsed_Host_prediction_to_genome_m90_duplicates_fix.csv", header = TRUE, sep=",")
...
nmr_chem = read.csv("env_chemistry_NMR_noGal.csv", header = T)

biogeochem = read.csv("env_biogeochemistry.csv", header=T, row.names = 1) 
...
lysogeny_vOTUs = read.csv("lysogenic_DNA_vOTU_expression_geTMM.csv", header = T)
...
lysogeny_vOTUs_RPK = read.csv("lysogenic_DNA_vOTU_expression_rpk.csv", header = T)
