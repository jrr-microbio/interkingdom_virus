...
# Read in the data
mapping_stats = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/read_mapping_statistics.csv", header = TRUE, sep=",")
...
mg_bacterial = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_1/data_stream_comparisons/viral_accumulation_curves/otu_table_filtered_reordered_DNA_bacteria_871.csv", header = T, sep=",", row.names = 1)

mg_eukfloat = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_1/data_stream_comparisons/viral_accumulation_curves/otu_table_filtered_reordered_DNA_EukFloat_3757.csv", header = T, sep=",", row.names = 1)

mg_virome = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_1/data_stream_comparisons/viral_accumulation_curves/otu_table_filtered_reordered_RNA_virome_3892.csv", header = T, sep=",", row.names = 1)

mg_total = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_1/data_stream_comparisons/viral_accumulation_curves/otu_table_filtered_reordered_DNA_total_1017.csv", header = T, sep=",", row.names = 1)

mt_bulk = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_1/data_stream_comparisons/viral_accumulation_curves/otu_table_filtered_reordered_RNA_bulkMetaT_4035.csv", header = T, sep=",", row.names = 1)

mt_virome = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_1/data_stream_comparisons/viral_accumulation_curves/otu_table_filtered_reordered_RNA_virome_3892.csv", header = T, sep=",", row.names = 1)

mt_polya = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_1/data_stream_comparisons/viral_accumulation_curves/otu_table_filtered_reordered_RNA_polyA_375.csv", header = T, sep=",", row.names = 1)
...
upset_otu_table = read.csv(file="~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/upset_plots/otu_table_filtered_reordered.csv", header=T, sep=',', row.names = 1)
...
datastream_metadat = read.csv(file="~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/vOTUs_per_data_stream_stats.csv", header=T, sep=',')
...
overlapping_vOTUs = read.csv("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/shared_votu_overlap_lengths.csv", header=T)
...
long_format_overlaps_updated = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/long_format_overlaps_v2.txt", sep = "\t")
...
mapping_detection = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/detection_analyses/filtered_coverM_counts_individual_samps_to_19769_ref.txt", sep = "\t", header = T, row.names = 1)
...
sampling_metadata = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/sampling_metadata_seqs.csv", sep = ",")
...
mapping_detection_RNA = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/detection_analyses/RNA_vOTUs/RNA_vOTU_output_abundance_counts_combined.tsv", sep = "\t", header = T, row.names = 1)
...
dnahosts = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/iPHoP/iphop_best_hits.csv", header = TRUE, sep=",")
...
#Now lets do RNA
rnahosts = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/iPHoP/rna_virus_hosts.csv", header = TRUE, sep=",")
...
mg_bacterial_counts = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/abundance_mapping_per_method/bacterial_filtered_coverM_counts.txt", header = T, sep="\t", row.names = 1)

mg_eukfloat_counts = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/abundance_mapping_per_method/fungal_filtered_coverM_counts.txt", header = T, sep="\t", row.names = 1)

total_DNA_counts = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/abundance_mapping_per_method/total_filtered_coverM_counts.txt", header = T, sep="\t", row.names = 1)

mg_virome_counts = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/abundance_mapping_per_method/virome_filtered_coverM_counts.txt", header = T, sep="\t", row.names = 1)
...
mt_bulk_counts = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/abundance_mapping_per_method/vOTU_output_abundance_counts_parsed_RNA_bulkMetaT_3862.tsv", header = T, sep="\t", row.names = 1)

mt_virome_counts = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/abundance_mapping_per_method/vOTU_output_abundance_counts_parsed_RNA_Virome_3787.tsv", header = T, sep="\t", row.names = 1)

mt_polya_counts = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/methods_comparisons/abundance_mapping_per_method/vOTU_output_abundance_counts_parsed_RNA_PolyA_372.tsv", header = T, sep="\t", row.names = 1)
...
moisture_per_sample = read.csv("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/_Supplemental_Tables/split/site_metadata.csv", sep = ",", header = T)
...
#DNA abundance 
counts_dna_abund = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/bulk_metaG_DNA_vOTU/TotalDNA_consolidatedDB_filtered_coverM_counts.txt", header = T, sep="\t") #coverM out
...
#DNA expression
counts_dna_expression = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/bulk_metaT_DNA_vOTU/featureCounts_output_CDS_reverse-stranded_paired.txt") #featureCounts out
...
#RNA abundance
counts_rna_abundance = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/bulk_metaT_RNA_vOTU/5893_genes_abundance_vOTUs.csv", header = T, sep=",") #geaParse template strand
...
#RNA expression
counts_rna_expression = read.delim("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/bulk_metaT_RNA_vOTU/5893_genes_expression_vOTUs.csv", header = T, sep=",") #geaParse non-template strand
...
Overall_jaccard_expression_proxy = read.csv("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/reads_from_metaT_to_vir_from_frac/processed_RNA_vOTU_tabs/Updated_jaccard_proxy_nonrel_expression.csv", header = T, row.names = 1)
...
datasets <- list(
  TotDNA_exp = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/reads_from_metaT_to_vir_from_frac/featureCounts_output_CDS_reverse-stranded_paired_TotDNA.txt", sep = "\t", header = T),
  VirDNA_exp = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/reads_from_metaT_to_vir_from_frac/featureCounts_output_CDS_reverse-stranded_paired_VirDNA.txt", sep = "\t", header = T),
  EukDNA_exp = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/reads_from_metaT_to_vir_from_frac/featureCounts_output_CDS_reverse-stranded_paired_Euk.txt", sep = "\t", header = T),
  BarDNA_exp = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/reads_from_metaT_to_vir_from_frac/featureCounts_output_CDS_reverse-stranded_paired_BAr.txt", sep = "\t", header = T)
)
...
TotRNA_vals = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/reads_from_metaT_to_vir_from_frac/TotRNA_vOTU_output_abund_exp_parsed.tsv", sep = "\t", header = T, row.names = 1)

VirRNA_vals = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/reads_from_metaT_to_vir_from_frac/VirRNA_vOTU_output_abund_exp_parsed.tsv", sep = "\t", header = T, row.names = 1)

PolyaRNA_vals = read.delim("/Volumes/Macintosh HD/Users/rodr771/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/reads_from_metaT_to_vir_from_frac/PolyA_vOTU_output_abund_exp_parsed.tsv", sep = "\t", header = T, row.names = 1)
...
Nonrelabund_jaccard_proxy_Tot = read.csv("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/reads_from_metaT_to_vir_from_frac/processed_RNA_vOTU_tabs/overall/Updated_jaccard_proxy_nonrel_expression_Tot.csv", header = T, row.names = 1)
...
Nonrelabund_jaccard_proxy_Vir = read.csv("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/reads_from_metaT_to_vir_from_frac/processed_RNA_vOTU_tabs/Vir/Updated_jaccard_proxy_nonrel_expression_Vir.csv", header = T, row.names = 1)
...
Nonrelabund_jaccard_proxy_Polya = read.csv("~/Library/CloudStorage/OneDrive-PNNL/Documents/3.4_interkingdom/paper_version_2/read_mapping_results/ecology_analyses/reads_from_metaT_to_vir_from_frac/processed_RNA_vOTU_tabs/PolyA/Updated_jaccard_proxy_nonrel_expression_Polya.csv", header = T, row.names = 1)
